export default (req, res) => {
  ...
  res.json({
    ...
    features: [
      {
        type: "Feature",
        geometry: { type: "Point", coordinates: [21.0317, 52.9146] },
        properties: {
          title: "Black Cat",
          cluster: false,
          venue: "blackcat",
      ...
      {
        type: "Feature",
        geometry: { type: "Point", coordinates: [20.023982, 50.878824] },
        properties: {
      ...
      {
        type: "Feature",
        geometry: { type: "Point", coordinates: [19.0423, 49.9224] },
        properties: {
          title: "Songbyrd Cafe",
          cluster: false,
          venue: "songbyrd",
      ...
      {
        type: "Feature",
        geometry: { type: "Point", coordinates: [21.0317, 38.9028] },
        properties: {
          title: "The Hamilton",
          cluster: false,
          venue: "thehamilton",
